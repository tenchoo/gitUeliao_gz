          ...
          <?php $this->widget('widgets.ZPagerNavigate', array('pages' => $pages, 'maxLinkCount' => 10));?>
            ...
            <tbody class="list-page-body">
              ...
              <tr class="list-body-bd">
				...
				<?php if( $this->userType == tbMember::UTYPE_SALEMAN && $val['state'] != '7' && $val['cState'] == '0' ) { ?>
					<a href="<?php echo $this->createUrl('checkchange',array('id'=>$val['orderId']));?>" target="_blank"  class="text-link">审核</a><br/>
				<?php } ?>

				<?php echo CHtml::link('订单详情',array('cview','id'=>$val['orderId'] ),array('class'=>'text-link')  );?>
               </td>
                <?php } ?>
              </tr>
              <?php } ?>
