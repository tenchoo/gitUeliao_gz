<div class="panel panel-default search-panel">
    <div class="panel-body">
        <form method="get" class="pull-left form-inline" action="<?php echo $this->createUrl('list')?>">
...
<table class="table table-condensed table-bordered">
    ...
    <tbody>
    <tr class="list-hd">
        <td colspan="4"><!-- <input type="checkbox" value="<?php echo $item->orderId; ?>"/> --><span
                class="first">订单编号：<?php echo $item->orderId; ?></span></td>
    </tr>
    <?php
    $begin = true;
    foreach ($item->products as $product) {
        ...
        <tr>
            ...
            if ($begin) {
                $begin = false;
                ?>
                <td rowspan="<?php echo count($item->products); ?>"><?php $this->widget('purchase.widgets.GuestOrderAction', array('orderId' => $item->orderId, 'state' => $item->state,'type'=>'view')); ?></td>
            <?php } ?>
        </tr>
    <?php }?>
    </tbody>
