...
<?php $this->beginContent('_tab',array('active'=>'glasstime','productId'=>$productId,'productType'=>$productType));$this->endContent();?>
...
<form action="" class="form-horizontal" method="post">
  ...
  <div class="form-group">
    <label class="control-label col-md-2"><span class="text-danger">*</span>设置呆滞时长：</label>
    <div class="control-div spec-set col-md-8">
      <div class="well batch-spec-set">
        批量设置：<input type="text" class="form-control input-sm int-only" maxlength="4">
      ...
      <ul class="clearfix inventory colors-checked list-unstyled">
        ...
        <li data-rel="<?php echo $val['relation'];?>">
          ...
          <input type="text" class="form-control input-sm int-only" placeholder="呆滞时长" value="<?php echo $val['glassTime'];?>" name="form[<?php echo $val['stockId']?>]" maxlength="4">小时
        </li>
        <?php  } ?>
      </ul>
    </div>
