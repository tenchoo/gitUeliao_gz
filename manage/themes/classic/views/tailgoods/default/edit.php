...
<?php $this->beginContent('//layouts/_error');$this->endContent();?>
 <h3 class="h4">价格设置</h3>
  ...
  <div class="form-group">
    ...
    <div class="col-md-4 ">
	 <label class="radio-inline"><input type="radio" name="tail[saleType]" value="retail" v-model="saleType" <?php if( $tail['saleType'] != 'whole' ) { ?>checked <?php } ?>>降价促销</label>
 ...
 <table class="table table-striped table-condensed table-hover table-bordered">
   <colgroup><col><col width="20%"><col width="20%"><col width="10%"></colgroup>
   <thead>
    <tr>
	 <td>产品编号</td>
     <td>所属仓库</td>
