...
<div class="panel panel-default search-panel">
    <div class="panel-body">
        <form role="search" class="pull-left form-inline" action="<?php echo $this->createUrl('/statistic/warehouse/output');?>">
...
<table class="table table-condensed table-bordered">
    ...
    <?php if(!$data_list):?>
        <tr>
            <td colspan="13" class="text-center">无数据显示</td>
        </tr>
        <?php
    else:
        ...
        foreach($data_list as $record){
            ...
            <tr class="text-center">
                ...
                <td><?php echo $record['outboundId'];?></td>
                ...
                <td><?php echo $record['sorting'];?></td>
                <td><?php echo $record['dispatching'];?></td>
