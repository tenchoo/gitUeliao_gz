 ...
 * @package CFormModel
 */
class PackingerForm extends CFormModel {
	...
	public function rules()	{
		return array(
			...
			/** 帐号唯一性检验 */
			array('account','unique','on'=>'create','className'=>'tbUser', 'attributeName'=>'account', 'message'=>Yii::t('base','')),
			/** 常规信息校验 */
			array('gender','in','range'=>array(0,1)),
			array('userId,departmentId,depPositionId', "numerical","integerOnly"=>true,'min'=>1),
			array('account', 'match', 'pattern'=>Regexp::$mobile, 'message'=>Yii::t('base','Mobile phone number format is not correct')),
			/** 其它 */
