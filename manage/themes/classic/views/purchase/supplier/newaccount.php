...
<form class="form-horizontal" method="post">
    <div class="form-group">
        ...
        <div class="col-md-4">
            <input type="hidden" name="form[supplierId]" value="<?php echo Yii::app()->request->getQuery('id');?>" />
            <input type="text" name="form[account]" value="<?php echo $seller->account;?>" class="form-control input-sm">
        </div>
    </div>
    <div class="form-group">
