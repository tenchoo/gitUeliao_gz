...
<div class="panel panel-default search-panel">
  <div class="panel-body">
    <form role="search" class="pull-left form-inline" action="<?php echo $this->createUrl('memberdetail');?>">
      ...
      <?php
        if($_GET && $data_list && $this->checkAccess('/statistic/excel/memberdetail')) {
          echo CHtml::link('导出数据', $this->createUrl('/statistic/excel/memberdetail', $_GET), ['class'=>"btn btn-primary",'role'=>"button"]);
        }
         ?>
    </form>
  </div>
