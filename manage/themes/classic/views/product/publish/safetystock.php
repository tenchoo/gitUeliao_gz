...
<?php $this->beginContent('_tab',array('active'=>'safetystock','productId'=>$productId,'productType'=>$productType));$this->endContent();?>
...
<form action="" class="form-horizontal" method="post">
  ...
  <div class="form-group">
    <label class="control-label col-md-2"><span class="text-danger">*</span>设置安全库存：</label>
    <div class="control-div spec-set col-md-8">
      <div class="well batch-spec-set">
        批量设置：<input type="text" class="form-control input-sm int-only" maxlength="6">
      ...
      <ul class="clearfix inventory colors-checked list-unstyled">
        ...
        <li data-rel="<?php echo $val['relation'];?>">
          ...
          <input type="text" class="form-control input-sm int-only" placeholder="安全库存" value="<?php echo $val['safetyStock'];?>" name="form[<?php echo $val['stockId']?>]"  maxlength="6">
        </li>
        <?php  }?>
      </ul>
    </div>
