  ...
  <table class="table table-condensed table-bordered">
   <colgroup><col width="50px"><col width="8%"><col width="8%"><col width="10%"><col><col width="8%"><col width="8%"><col width="8%"><col width="8%"><col width="8%"><col><col width="50px"></colgroup>
   <thead>
    <tr>
	 <td>序号</td>
     <td>订单号</td>
