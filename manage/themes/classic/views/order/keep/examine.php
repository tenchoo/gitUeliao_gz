...
<form method="post">
    ...
    <div class="panel panel-default">
        ...
        <ul class="list-group">
            <li class="list-group-item clearfix">
                <span class="col-md-12">留货时间：<?php echo $order->createTime; ?> 至 <?php echo $expireTime; ?></span>
            </li>
            <li class="list-group-item clearfix">
                <span class="col-md-4">审核结果：
                    <label class="radio-inline"><input type="radio" name="state" value="1"/>同意留货</label>
                    <label class="radio-inline"><input type="radio" name="state" value="2"/>不同意留货</label>
                </span>
            </li>
            <li class="list-group-item clearfix"><span class="col-md-8">原因：<label class="radio-inline"><textarea name="cause" class="form-control"></textarea></label></span></li>
        </ul>
    </div>
