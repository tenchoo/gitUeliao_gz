...
var Emoji = {
	...
	emojiPath: '/themes/classic/statics/libs/emoji/1.0.0/emoji/',
	...
	trans:  function(text) {
		...
		text = text.replace(Emoji.reg, function(code) {
			return '<img width="20" class="emoji" style="vertical-align:middle" src="' + Emoji.emojiPath + Emoji._escapeToUtf32(code) + '.png">';
		});
